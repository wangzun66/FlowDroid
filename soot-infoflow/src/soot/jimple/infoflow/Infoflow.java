...
import soot.jimple.infoflow.aliasing.sparse.AdaptiveSparseBoomerangAliasStrategy;
...
public class Infoflow extends AbstractInfoflow {
	...
	protected IAliasingStrategy createAliasAnalysis(final ISourceSinkManager sourcesSinks, IInfoflowCFG iCfg,
		...
		case AliasAwareSparseBoomerang:
			...
			break;
		case AdaptiveSparseBoomerang:
			backProblem = null;
			backSolver = null;
			aliasingStrategy = new AdaptiveSparseBoomerangAliasStrategy(manager);
			break;
		default:
